...
import time
from queuemgr.simple_api import queue_system, add_job, start_job, get_job_status, list_jobs
...
def main():
    ...
    from queuemgr.simple_api import start_queue_system, stop_queue_system
