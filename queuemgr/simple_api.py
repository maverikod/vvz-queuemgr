...
from .process_manager import ProcessManager, ProcessManagerConfig, ProcessManagerContext
...
def get_queue_system(registry_path: str = "queuemgr_registry.jsonl",
                    shutdown_timeout: float = 30.0) -> QueueSystem:
    """
...
@contextmanager
def queue_system(registry_path: str = "queuemgr_registry.jsonl",
                shutdown_timeout: float = 30.0):
    """
...
def start_queue_system(registry_path: str = "queuemgr_registry.jsonl",
